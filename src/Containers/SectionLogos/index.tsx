...
const SectionLogos = () => {
  return (
    <>
      <div className='bg-FundoSectionLogos mb-96 mt-20 md:mt-60 max-w-[1200px] mx-auto'>
        <div className='flex flex-col items-center text-center md:flex-row md:text-start md:justify-between'>
          <h2 className='text-4xl font-bold text-center capitalize pt-20 md:text-start md:ps-5 '>
